        ...
        if not self.pluginIsActive:
            ...
            class PDF(FPDF):  # ----печать данных без вывода в файл
                ...
                def head(self, Layer_Source_Name, SelectedFeature):
                    # -------------------------------------печать бланка-------------
                    self.image("T:/NOVOKUZ/Герб/Герб.jpg", x=30, y=10, w=10, h=0, type='jpg', link='')
                    self.ln(18)
                    ...
                    for i in range(5):
                        self.set_y(k)
                        self.set_x(100)
                        self.cell(75, 6, fields_source[i].name())
                        self.cell(100, 6, str(SelectedFeature.attribute(fields_source[i].name())))
                        k += 6
                        i += 1

                    self.cell(30, 6, "Дата и время запроса:")
                    self.cell(30, 6, str(dt.datetime.now()))

                    self.ln(10)
                    self.set_draw_color(0, 0, 0)
                    self.cell(400, 1, "", 1, 0, "C")
            ...
            def isogd():
                ...
                col_widths = [
                              ...
                              [30, 25, 200, 30, 30, 15, 14, 14, 14, 14, 14], # T:/NOVOKUZ/_Правила землепользования и застройки/Территориальные_зоны_пр.TAB
                              [20, 20, 20, 146, 60, 20, 20, 20, 20, 20, 20, 14],  # T:/NOVOKUZ/ФГУ участки/KK.TAB

                              [12, 18, 30, 80, 40, 36, 20, 22, 20, 20, 36, 22, 10, 10, 10, 14], # T:/NOVOKUZ/Участки.TAB
                              ...
                              [16, 38, 20, 20, 64, 20, 30, 24, 36, 56, 20, 14, 14, 14, 14], #T:/NOVOKUZ/КУМИ_схема_расположения.TAB
                              [42, 72, 64, 42, 20, 20, 42, 42, 42, 14],  # T:/NOVOKUZ/Предварительно согласованные.TAB
                              [38, 38, 38, 24, 38, 38, 38, 40, 40, 40, 14, 14], #T:/NOVOKUZ/КУМИ_предварительно_согласованные_с_кадастровым_номером.TAB
                              ...
                              [10, 10, 30, 10, 20, 20, 10, 10, 280],  # T:/NOVOKUZ/ФГУ участки/ACTUAL_ZOUIT.TAB
                              ...
                              [27, 30, 100, 50, 16, 18, 36, 110, 14], # T:/NOVOKUZ/Запреты/Ликвидация последствий горных выработок/ЛиквидацияОстатковШахт_не предоставлять.TAB
                              [100, 286, 14], # T:/Темы/Сибиреязвенное захоронение.TAB
                              [16, 16, 20, 50, 70, 70, 22, 22, 100, 14],  # T:\NOVOKUZ\Месторождения полезных ископаемых

                              [64, 130, 64, 64, 64, 14],  # T:/Темы/Реки города.TAB
                              [20, 100, 266, 14],  # 'T:/NOVOKUZ/ПРОЕКТЫ/План лесонасаждений городских лесов/Отцифрованный А-3_горНовокузнецк_КатЗащ/Городские леса'

                              [300, 86, 14],  # T:/NOVOKUZ/Граница Новокузнецкого городского округа.TAB
                              [20, 300, 66, 14]  # T:/NOVOKUZ/Граница населенного пункта город Новокузнецк.TAB
                            ]
